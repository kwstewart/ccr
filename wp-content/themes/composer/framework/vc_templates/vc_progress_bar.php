 ...
 */
$title = $values = $units = $bgcolor = $css = $custombgcolor = $customtxtcolor = $options = $el_class = $style = $el_id = $css_animation = '';
$output = '';
...
$output = '<div class="' . esc_attr( $css_class ) . ' pix-progress-bar ' . $style . '" ' . implode( ' ', $wrapper_attributes ) . '>';
