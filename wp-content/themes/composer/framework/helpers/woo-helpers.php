<?php
                ...
                echo '<div class="pix-cart">';
                    ...
                    echo '<div class="cart-trigger">';
                        echo '<div class="pix-cart-contents-con">';                 
                            echo '<a class="pix-cart-contents" href="'. esc_url( wc_get_cart_url() ) .'" title="'. esc_html__( 'View your shopping cart', 'composer' ) .'">';
                                echo '<span class="pixicon-handbag pix-cart-icon"></span><span class="pix-item-icon">'. esc_html( WC()->cart->cart_contents_count ) .'</span>';
                            echo '</a>';
                        echo '</div>';
    ...
    if( !function_exists( 'composer_woocommerce_header_add_to_cart_fragment' ) ) { 
        function composer_woocommerce_header_add_to_cart_fragment( $fragments ) {
            ...
            echo '<div class="pix-cart-contents-con">';             
                echo '<a class="pix-cart-contents" href="'. esc_url( wc_get_cart_url() ) .'" title="'. esc_html__('View your shopping cart', 'composer' ) .'"><span class="pixicon-handbag pix-cart-icon"></span><span class="pix-item-icon">'. esc_html( WC()->cart->cart_contents_count ) .'</span></a>';
            echo '</div>';
    ...
    function composerAddShortcodesCustomCss() {
    ...
    add_action( 'wp_head', 'composerAddShortcodesCustomCss', 1000 );