...
$of_options[] = array( "name" => esc_html__("Shortcode", 'composer' ),
...
$of_options[] = array( "name" => esc_html__("Youtube URL", 'composer' ),
					"desc" => esc_html__("Enter your full Youtube URL, This will display in header.", 'composer' ),
					"id" => "top_youtube",
					"std" => "",
					"type" => "text");

$of_options[] = array( "name" => esc_html__("Vimeo URL", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Body Container Background Color", 'composer' ),
						"desc" 		=> esc_html__("It applies body background color for all pages", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Title Bar Title Tag", 'composer' ),
...
$of_options[] = array( "name" => esc_html__("Upload Retina Sticky Logo", 'composer' ),
...
$of_options[] = array(  "name"  => esc_html__("Visual Composer frontend", 'composer' ),
...
$of_options[] = array( "name" => esc_html__("Menu Responsive Breakpoint", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Menu Text Transform", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Sticky Background Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Sticky Link Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Sticky Link Hover Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Hambarger Background Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Hambarger Link Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Hambarger Link Hover Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Hambarger Close Icon Color", 'composer' ),
...
$of_options[] = array(  "name"  => esc_html__("Custom Mobile Menu Styles", 'composer' ),
						"desc"  => esc_html__("Do you like to use Custom Styles, Please enable it and choose the Background color, Primary color, Selection text color, selection background color, link hover color. If it's disabled, the default style will apply and custom styles are won't apply.", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Hambarger Icon Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Background Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Text Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Text Hover Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Text Active Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Border Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Arrow Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Menu Arrow Hover Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Sub Menu Background Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Sub Menu Text Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Sub Menu Text Hover Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Sub Menu Border Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Sub Menu Arrow Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Mobile Sub Menu Arrow Hover Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Choose Login Page", 'composer' ),
...
$of_options[] = array( 
						...
						"desc" => esc_html__( "Please Enter the Welcome text for login logout link. note: '{username}' will be replaced by user's display name", 'composer' ),
						"id" => "welcome_text",
...
$of_options[] = array( 	"name" 		=> esc_html__("Choose Portfolio Page", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Hide/skip Portfolio Categories", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Show Image Caption", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Blog Content Type", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Title Tag", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Image Width", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Image Height", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Show/Hide Author meta", 'composer' ),
						"desc" 		=> esc_html__("Do you want to display like meta", 'composer' ),
						"id" 		=> "single_author",
						"std" 		=> "show",
						"options"	=> array(
...
$of_options[] = array( 	"name" 		=> esc_html__("Related Post Columns", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("No Search result title", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("No Search result content", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Footer Layout Style.", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Container Background Color", 'composer' ),
						"desc" 		=> esc_html__("This is the container background color.(its applied for most of the items in the theme such as button, link etc..", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Top Meta Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Top Meta Background Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Title Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Meta Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Meta Link Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Caption Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Banner Background Color", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Single Blog Banner Title", 'composer' ),
...
$of_options[] = array( 	"name" 		=> esc_html__("Single Blog Banner Meta", 'composer' ),
