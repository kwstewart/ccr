...
if( !defined('COMPOSER_COMPOSER_ADMIN_PATH') )
	define( 'COMPOSER_ADMIN_PATH', get_template_directory() . '/framework/theme-options/admin/' );
if( !defined('COMPOSER_ADMIN_DIR') )
	define( 'COMPOSER_ADMIN_DIR', get_template_directory_uri() . '/framework/theme-options/admin/' );

define( 'ADMIN_IMAGES', COMPOSER_ADMIN_DIR . 'assets/images/' );

define( 'LAYOUT_PATH', COMPOSER_ADMIN_PATH . 'layouts/' );
 ...
 * @since 1.0.0
 */ 
composer_require_file ( COMPOSER_ADMIN_PATH . 'functions/functions.load.php' );
composer_require_file ( COMPOSER_ADMIN_PATH . 'classes/class.options_machine.php' );
