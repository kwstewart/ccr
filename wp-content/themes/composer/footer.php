...
<?php
	...
	${$prefix.'footer_width'} = composer_get_meta_value( $id, '_amz_footer_width', 'default', 'footer_width', 'boxed' ); // id, meta_key, meta_default, themeoption_key, themeoption_default

	/* Footer Container Width */
	if( ${$prefix.'footer_width'} === 'wide' ){
		$footer_width_class = ' footer-full-width';
	} else {
		$footer_width_class = '';
	}
	...
	?>
		<footer id="footer" class="<?php echo esc_attr( $composer_footer_style . $footer_width_class . $composer_footer_fixed_class . $f_widget_mobile_hide_class . $f_small_mobile_hide_class ); ?>">
			<?php 
