<?php
	...
	$block = array(
		...
		'portfolio_block13' => esc_html__( 'Portfolio Block 13', 'composer' )
	);
	foreach ( $block as $key => $value ) {
        ...
        $block_count = $portfolio_blocks->get_post_count( $key );
			...
			"params" => array(
				...
				array(
					...
					"value" => array(
						...
						esc_html__('style 7', "composer") => "style7"),
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("Number of Items", "composer"),
					"param_name" => "no_of_items",
					"value" => $block_count,
					"description" => esc_html__("Type the integer value.If its -1 it loads all the items.", "composer")
				),
