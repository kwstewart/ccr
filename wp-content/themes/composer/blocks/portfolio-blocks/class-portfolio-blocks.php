<?php
    class portfolio_blocks {
        ...
        public function terms( $show_terms = 'yes' ) {
            ...
            if( 'yes' == $show_terms ) {
                $terms = composer_get_the_term_list( get_the_ID() , 'pix_categories','',', ' );
        ...
        public function filter( $show_filter = 'yes', $filter_style = 'normal', $filter_array = array() ) {
                ...
                if( ! empty( $filter_array ) ){
                    $output .= '<div class="sorter no-portfolio-carousel '. esc_attr( $filter_style ) .'">';
                        $output .= '<div class="filter-wrapper">';
                            ...
                            $output .= "<ul id='filters' class='filter-sort option-set ". esc_attr( $filter_style ) ." clearfix' data-categories='". json_encode( $filter_array ) ."'>";
                                $term_links = '';
                                ...
                                $output .= apply_filters( 'composer_portfolio_filter', $term_links, $filter_array );
                            $output .= '</ul>';
                        $output .= '</div>'; // .filter-wrapper
                    $output .= '</div>'; // .sorter
                }
