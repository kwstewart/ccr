    ...
    if( 'col3' == $composer_footer_widget_layout || 'col4' == $composer_footer_widget_layout ) {
        ...
        if( 'fl-12' != $composer_footer_widget_layout && 'fl-6-6' != $composer_footer_widget_layout && 'fl-4-8' != $composer_footer_widget_layout &&'fl-8-4' != $composer_footer_widget_layout ) {
            ...
            if( 'fl-12' != $composer_footer_widget_layout && 'fl-3-3-6' != $composer_footer_widget_layout && 'fl-3-6-3' != $composer_footer_widget_layout && 'fl-6-3-3' != $composer_footer_widget_layout && 'fl-6-6-12' != $composer_footer_widget_layout && 'fl-4-8-12' != $composer_footer_widget_layout && 'fl-8-4-12' != $composer_footer_widget_layout && 'fl-4-4-4' != $composer_footer_widget_layout && 'fl-2-2-8' != $composer_footer_widget_layout && 'fl-2-8-2' != $composer_footer_widget_layout && 'fl-8-2-2' != $composer_footer_widget_layout ) {
                ...
                if( 'fl-3-3-3-3-12' == $composer_footer_widget_layout || 'fl-2-2-2-2-2-2' == $composer_footer_widget_layout || 'fl-2-2-2-2-2-2-12' == $composer_footer_widget_layout ) {
...
function composer_scripts_and_styles() {
    ...
    if ( !is_admin() ) {
        ...
        wp_enqueue_style( 'composer-fonts', get_template_directory_uri() . '/_css/pix-icons.css', array(), '3.1.3', 'all' );
        ...
        wp_enqueue_style( 'composer-animate-stylesheet', get_template_directory_uri() . '/_css/animate.min.css', array('bootstrap'), '3.1.3', 'all' );

        wp_enqueue_style( 'composer-stylesheet', get_template_directory_uri() . '/_css/main.css', array('bootstrap'), '3.1.3', 'all' );

        wp_enqueue_style( 'bbpress', get_template_directory_uri() . '/_css/bbpress.css', array('bootstrap'), '1.0', 'all' );

        wp_enqueue_style( 'composer-plugins-stylesheet', get_template_directory_uri() . '/_css/plugins.css', array('composer-stylesheet'), '3.1.3', 'all' );

        if ( class_exists('WooCommerce') ) {
            wp_enqueue_style( 'composer-woo-stylesheet', get_template_directory_uri() . '/_css/woo.css', array( 'composer-plugins-stylesheet' ), '3.1.3', 'all' );
        }

        if ( is_rtl() ) {
            wp_enqueue_style( 'composer-rtl-stylesheet', get_template_directory_uri() . '/_css/rtl.css', array( 'composer-plugins-stylesheet' ), '3.1.3', 'all' );
        }
        

        $to_last_saved_time = get_theme_mod( 'to_last_saved_time', '3.1.3' );
        ...
        if( 'on' === $mobile_responsive ){
            wp_enqueue_style( 'composer-responsive-stylesheet', get_template_directory_uri() . '/_css/responsive.css', array('composer-stylesheet'), '3.1.3', 'all' );
        }else{
            wp_enqueue_style( 'composer-responsive-stylesheet', get_template_directory_uri() . '/_css/non-responsive.css', array('composer-custom-css'), '3.1.3', 'all' );
        }
        ...
        if ( class_exists('WPBakeryVisualComposerAbstract')  && 'yes' === $pix_ajax ) {
            wp_enqueue_script( 'composer-plugins-js', get_template_directory_uri() . '/_js/plugins.js', array( 'jquery', 'jquery-ui-tabs', 'jquery-ui-accordion', 'jquery_ui_tabs_rotate', 'prettyphoto', 'waypoints', 'vc_jquery_skrollr_js', 'wpb_composer_front_js' ), '3.1.3', $load_script_in_footer );
        }else{
            wp_enqueue_script( 'composer-plugins-js', get_template_directory_uri() . '/_js/plugins.js', array( 'jquery', 'waypoints' ), '3.1.3', $load_script_in_footer );
        }
        ...
        if( !isset( $_GET['vc_editable'] ) ){
            wp_enqueue_script( 'composer-js', get_template_directory_uri() . '/_js/scripts.js', array( 'jquery', 'waypoints', 'composer-plugins-js' ), '3.1.3', $load_script_in_footer );
        }
