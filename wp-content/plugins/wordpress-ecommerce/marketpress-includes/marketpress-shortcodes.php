...
class MarketPress_Shortcodes {
  ...
  function __construct() {
    ...
    add_shortcode( 'mp_list_products_grid', array(&$this, 'mp_list_products_grid_sc') );
  ...
  function mp_list_products_sc($atts) {
    ...
    function mp_list_products_grid_sc($atts) {
    extract(shortcode_atts(array(
  		'paginate' => '',
  		'page' => '',
  		'per_page' => '',
    ...
    return mp_list_products_grid(false, $paginate, $page, $per_page, $order_by, $order, $category, $tag);
  }
