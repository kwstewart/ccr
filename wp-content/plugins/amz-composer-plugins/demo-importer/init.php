...
define( 'AMZ_IMPORTER_DIR' , AMAZEE_PLUGIN_DIR . 'demo-importer' );
define( 'AMZ_IMPORTER_URI' , AMAZEE_PLUGIN_URL . '/demo-importer' );
...
$options        = array(
    ...
    'bed-breakfast' => array(
        'title'         => __('Bed and Breakfast', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/bed-breakfast/',
        ),
    'fleur' => array(
        'title'         => __('Fleur', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/fleur/',
        ),
    'insurance' => array(
        'title'         => __('Insurance', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/insurance/',
        ),
    'notebook' => array(
        'title'         => __('Notebook', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/notebook/',
        ),
    'pharma' => array(
        'title'         => __('Pharma', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/pharma/',
        ),
    'soyyo' => array(
        'title'         => __('Soyyo', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/soyyo/',
        ),
    'suitcase' => array(
        'title'         => __('Suitcase', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/suitcase/',
        ),
    'niranjas' => array(
        'title'         => __('Naranjas', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/naranjas/',
        ),
    'sports-tennis' => array(
        'title'         => __('Sports Tennis', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/sports-tennis/',
        ),
    'top-invest' => array(
        'title'         => __('Top Invest', 'amz-importer'),
        'preview_url'   => 'http://innwithemes.com/composer/top-invest/',
        ),
    'business-10' => array(
